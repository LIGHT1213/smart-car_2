...
//-------------------------------------------------------------------------------------------------------------------
void gpio_init(PTX_n ptx_n, GPIO_MOD ddr, uint8_t dat)
{
    volatile uint8_t ptx,ptn;
    uint32_t temp;
...
//  @since      v2.0
//  Sample usage:               uint8_t status = gpio_get(A5);   //读取A5为状态
//-------------------------------------------------------------------------------------------------------------------
uint8_t gpio_get(PTX_n ptx_n)
{
    volatile uint8_t ptx,ptn;
    uint32_t temp;
...
//-------------------------------------------------------------------------------------------------------------------
void gpio_set(PTX_n ptx_n, uint8_t dat)
{
    volatile uint8_t ptx,ptn;
    uint32_t temp;
