...
//  @return     void
//  @since      v2.0
//  Sample usage:               uint16_t dat = adc_once(ADC0_SE8,ADC_12bit);//采集ADC0_SE8电压，分辨率12位
//-------------------------------------------------------------------------------------------------------------------
uint16_t adc_once(ADCn_Ch adcn_ch, ADC_nbit bit)
{
#ifdef OVERC_SOURCE_CORECLOCK_80M
